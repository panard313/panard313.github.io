...
- [ ] 尝试是否能找到适合google pixel 2xl的4.15以上的内核，若能找到，编译一个可开启cgroup v2的版本并测试．
- [ ] 继续研究组迁移时的逻辑，若与推测相符，提出修改思路．
- [ ] 根据对iolatency的已有研究，尝试移植到4.9版本内核上去
- [ ] 补充generic_make_request与设备驱动之间的联系
- [ ] 研究一下latency_unknown由来， 优先级低
- [ ] 研究队列深度对组写入速度的影响
- [ ] 研究一种在一些位置打印出组信息，队列信息，队列深度的方法
- [ ] 研究组切换时，能否实时调整组深度，和实时的组深度变化
- [ ] 研究generic_perform_request与pagecache的路径关系
- [ ] 研究wb_timer_fn与时间窗口是否对应
- [ ] emmc流程需要抓log整理，找出一些方法指针的对应
